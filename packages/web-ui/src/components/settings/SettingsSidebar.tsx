...
const PAGES: Array<{ id: SettingsPage; label: string; icon: string; description: string }> = [
  ...
  { id: 'models', label: 'Model Control', icon: 'M21 16.5V8.25a2.25 2.25 0 0 0-1.172-1.98l-7.5-4.5a2.25 2.25 0 0 0-2.328 0l-7.5 4.5A2.25 2.25 0 0 0 1.5 8.25v8.25a2.25 2.25 0 0 0 1.172 1.98l7.5 4.5a2.25 2.25 0 0 0 2.328 0l7.5-4.5A2.25 2.25 0 0 0 21 16.5Z M12 9.75v10.5m5.25-7.5L12 9.75 6.75 12.75', description: 'Downloads, load, benchmark' },
