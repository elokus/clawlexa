"""
Real-time streaming client for Qwen3-TTS server — plays audio chunks AS they arrive.

Same protocol as kokoro and mlx-audio clients for direct comparison.

Usage:
    uv run python client_stream_rt.py "Guten Tag, wie geht es Ihnen?"
    uv run python client_stream_rt.py --seed 123 "Hallo Welt"
    uv run python client_stream_rt.py --lang en-us "Hello world"
"""
